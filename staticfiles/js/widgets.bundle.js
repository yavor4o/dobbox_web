...
// Class definition
var KTChartsWidget118 = function () {
    var chart = {
        self: null,
        rendered: false
    };
    ...
    var initChart = function(chart) {
        var element = document.getElementById("kt_charts_widget_118_chart");
        ...
        var options = {
            series: [{
                name: 'Spent time',
                data: [54, 42, 75, 110, 23, 87, 50,111,123,22,44,66,]
            }],
            chart: {
                fontFamily: 'inherit',
                type: 'bar',
            ...
            xaxis: {
                categories: ['QA Analysis', 'Marketing', 'Web Dev', 'Maths', 'Front-end Dev', 'Physics', 'Phylosophy','Phylosophy','Phylosophy','Phylosophy','Phylosophy','Phylosophy'],
                axisBorder: {
                    show: false,
                },
                axisTicks: {
...
var KTTablesWidget4 = function () {
    ...
    const handleStatusFilter = () => {
        const select = document.querySelector('[kt_table_transport_table="filter_status"]');
...
var KTTablesWidget50 = function () {
    ...
    return {
        init: function () {
            table = document.querySelector('#kt_table_widget_50_table');
...
// Webpack support
if (typeof module !== 'undefined') {
    module.exports = KTTablesWidget50;
}

// On document ready
KTUtil.onDOMContentLoaded(function () {
    KTTablesWidget50.init();
});
